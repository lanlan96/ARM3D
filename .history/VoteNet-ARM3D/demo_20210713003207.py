...
parser.add_argument('--model', default='mlcvnet', help='Model for visualization. [default: mlcvnet,votenet,mlcvnet_3DRM,votenet_3DRM, votenet_ARM_3D, mlcvnet_ARM_3D]')
parser.add_argument('--num_target', type=int, default=256, help='Point Number [default: 256]')

FLAGS = parser.parse_args()


if FLAGS.model not in ['mlcvnet','votenet']:
