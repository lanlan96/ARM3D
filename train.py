...
# FLAGS.relation_type = ['same_category','support'] 
# FLAGS.relation_type = ['support'] 
FLAGS.relation_type = ['same_category'] 
...
if FLAGS.random:
    ...
    ranornear = "_nearest_"
FLAGS.log_dir = FLAGS.log_dir + '/log_rn' + str(FLAGS.relation_pair) + '_' + "_".join(FLAGS.relation_type) + ranornear+time_string+"_semantic" 
